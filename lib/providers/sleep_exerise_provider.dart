...
class SleepExeriseProvider extends ChangeNotifier{
  List<SleepExerice>_allSleepExercises=[];
  List<SleepExerice> sleepExercise=[];
  ...
  SleepExericeProvder(){
    ...
    sleepExercise = List.from(_allSleepExercises);
  }
}