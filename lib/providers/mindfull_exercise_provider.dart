...
class MindfullExerciseProvider extends ChangeNotifier{
  List<MindfullnessExerice>_allMindfullExerciese=[];
  List<MindfullnessExerice> mindfullExercise=[];

  MindfullExerciseProvider(){
    _allMindfullExerciese=[
       MindfullnessExerice(
        category: "Beginners",
    ...
    mindfullExercise=List.from(_allMindfullExerciese);
  }
}